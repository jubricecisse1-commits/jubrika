...
// Normaliser un numéro de téléphone (supprimer espaces, +, -)
export function normaliserTelephone(tel: string): string {
  return tel.replace(/[\s\-\(\)]/g, "");
}

// Générer un QR code data URL (wrapper)
...
// Calculer le début d'une période
...
// Couleurs pour les graphiques (palette JUBRIKA)
...
// Emoji médaille pour le classement
